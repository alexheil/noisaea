class ArtistProfile < ActiveRecord::Base
  ...
  has_attached_file :cover_img, styles: { perfect: "1920x640>", small: "800x267>" }, :url => ":s3_us_west_url"
  has_attached_file :profile_img, styles: { perfect: "500x500>", small: "150x150>" }, :url => ":s3_us_west_url"
