class Recordlabels::ProfilesController < ApplicationController
  ...
  private
    ...
    def profile_params
      params.require(:record_label_profile).permit(:biography, :location, :genre, :artists, :founded, :website, :facebook_url, :twitter_url, :youtube_url, :itunes_url, :amazon_url, :google_play_url, :ticketfly_url, :cover_image, :profile_image)
    end
