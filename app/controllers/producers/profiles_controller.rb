class Producers::ProfilesController < ApplicationController
  ...
  private
    ...
    def profile_params
      params.require(:producer_profile).permit(:biography, :location, :genre, :artists, :founded, :facebook_url, :twitter_url, :youtube_url, :website, :letlyrics_url, :theme_color, :cover_image, :profile_image)
    end
