class Artists::ShowsController < ApplicationController
  ...
  def index
    ...
    @shows = @artist.artist_shows.page params[:page]
  end
  ...
  private
    ...
    def show_params
      params.require(:artist_show).permit(:artist_id, :month, :day, :year, :location, :venue, :description, :ticket_url, :flyer_url, :flyer_img, :headline_artist, :support_artist1, :support_artist2, :support_artist3, :support_artist4, :support_artist5, :support_artist6, :support_artist7)
    end
